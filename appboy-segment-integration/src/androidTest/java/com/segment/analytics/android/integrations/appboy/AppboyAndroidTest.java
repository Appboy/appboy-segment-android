...
public class AppboyAndroidTest {
  ...
  public void testIdentifyCallsChangeUser() {
    ...
    IdentifyPayload identifyPayload = new IdentifyPayload
      ...
      .build();
    AppboyIntegration integration = new AppboyIntegration(getContext(), Appboy.getInstance(getContext()), "token", Logger.with(Analytics.LogLevel.DEBUG), true, true, null);
